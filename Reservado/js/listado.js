...
Listado.prototype.buscarRestaurante = function (id) {
    ...
    //     }
    // }
    var restoEncontrado = this.restaurantes.find(restaurant => restaurant.id === id);
...
Listado.prototype.obtenerUbicaciones = function () {
    ...
    var ubicacionesSinRepetir = soloUnicosEnArray(ubicaciones);
...
Listado.prototype.obtenerRubros = function () {
    ...
    var rubrosSinRepetir = soloUnicosEnArray(rubros);
...
Listado.prototype.obtenerHorarios = function () {
    ...
    // }
    var arraysHorarios = this.restaurantes.map(restaurant => restaurant.horarios);
    ...
    var horariosSinRepetir = soloUnicosEnArray(todosLosHorarios);
...
function soloUnicosEnArray(array) {
    var unicos = array.filter((elem, index, self) => index === self.indexOf(elem));
    return unicos;
};